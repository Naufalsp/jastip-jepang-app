      ...
      <div className="w-full max-w-xl bg-white rounded-3xl border border-slate-900 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-2">
          ...
          <div className="flex items-center justify-between bg-white p-3.5 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="bg-amber-500 text-white font-black text-xs px-2.5 py-1 rounded-lg tracking-wide">
                Jago
              </div>
              <div>
                <p className="text-[11px] text-slate-500 font-medium">
                  Nomor Rekening a/n <span className="font-bold text-slate-800">SRI WAHYUNINGSIH</span>
                </p>
            ...
            <button
              type="button"
              onClick={() => {
                navigator.clipboard.writeText('100282579294');
                alert('Nomor rekening berhasil disalin!');
              }}
              className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-lg transition active:scale-95"
            >
              📋 Salin
            </button>
          </div>
            ...
            <form onSubmit={handleUploadProof} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className={`grid ${isDpPaid ? 'grid-cols-1' : 'grid-cols-2'} gap-3`}>
                  ...
                  {/* TOMBOL BAYAR DP - SEMBUNYI JIKA SUDAH BAYAR DP */}
                  {!isDpPaid && (
                    <button
                      type="button"
                      onClick={() => setPaymentType('dp')}
