...
//   // KONDISI STOK TIDAK ADA / DIBATALKAN
//   if (
//     actionType === 'status_change' && 
//     (newStatus === 'tidak_ada_stok' || newStatus === 'stok_kosong' || newStatus === 'out_of_stock' || newStatus === 'cancelled')
//   ) {
//     message = `Halo Kak ${customerName}! ❌\n\nMohon maaf, pesanan kamu *${orderNumber}* saat ini *TIDAK TERSEDIA* / Stok Habis di Jepang.\n\nPesanan ini telah dibatalkan oleh Admin. Kamu dapat melihat detail status pesanan kamu di tautan berikut:\n${orderLink}\n\nTerima kasih atas pengertiannya! 🙏🇯🇵`;
//   }
...
//   // KONDISI 3B: Pembayaran LUNAS Diverifikasi saat barang masih di Jepang (Sebelum Tiba di Indo)
//   else if (
//     actionType === 'verify_final' && 
//     (newStatus === 'berangkat_dari_jepang' || order.order_status !== 'tiba_di_indonesia')
//   ) {
